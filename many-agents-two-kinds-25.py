...
agent_kind_B = [25,    50   , 50,  200., 500.]

agents.my_preferences = np.array(25*[agent_kind_A] + 75*[agent_kind_B])
...
for i in range(num_agents):
                style = ':'
                if agent_names[i] == 'intelligent_agent' or agent_names[i] == 'A':
                        style = 'k-'
                if agent_names[i] == 'B':
                        style = 'r--'
                if agent_names[i] == 'S2':
