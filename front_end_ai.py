...
with myFile:
        ...
        writer.writerow('Goods for each Agent')
        for i in range(num_agents):
        ...
        writer.writerow(())
        writer.writerow(('Marginal Utility'))
        for i in range(num_agents):
                marginal = agents.marginal_utilities(i, agents.goods[i])
